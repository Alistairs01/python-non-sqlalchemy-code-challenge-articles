class Article:
    ...
    def title(self, title_value: str):
        ...
        if isinstance(title_value, str) and 5 <= len(title_value) <= 50:
            ...
            raise ValueError("Title must be a str and have between 5 and 50 characters.")
...
class Author:
    ...
    def name(self, name_value: str):
        ...
        if isinstance(name_value, str) and len(name_value) > 0:
            ...
            raise ValueError("Name must be a str and must have more than 0 characters.")
...
class Magazine:
    ...
    def name(self, name_value: str):
        if isinstance(name_value, str) and 2 <= len(name_value) <= 16:
            ...
            raise ValueError("Magazine name must be a str and have between 2 and 16 characters.")
    ...
    def category(self, category_value: str):
        if isinstance(category_value, str) and len(category_value) > 0:
            ...
            raise ValueError("Category must be a str with more than 0 characters.")
